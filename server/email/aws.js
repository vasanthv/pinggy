	...
	var params = {
		...
		Message: {
			...
			Body: {
				Html: {
					Charset: "UTF-8",
					Data: `Hello @${username}<br/><br/>Your password to log in to your Pinggy account is: <b>${password}</b><br/><br/>Note: Please change your password immediately after logging in.<br/><br/>Thanks<br/>`,
				},
				Text: {
					Charset: "UTF-8",
...
const sendInviteEmail = (user, email) => {
	...
	sendEmailFromHTMLBody(`[Pinggy.com] ${user.username} has invited you to join Pinggy.`, emailHTML, [{ email }]);
};
